...
function mulaiKuis() {
  ...
  var waktu = 30; // 30 menit dalam detik
  var timer = setInterval(function () {
    ...
    if (waktu < 0) {
      ...
      setTimeout(function () {
        ...
        window.location.href = "i-ipa-sulit.php";
...
$sql = "SELECT * FROM ipa_sulit ORDER BY RAND() LIMIT 15";
...
<div class='tayo'>
    <div>
    <h1>Kamu akan menjawab soal Ilmu Pengetahuan Alam tingkat Sulit</h1>
