...
include "conn.php";
  if (isset($_POST['simpan'])) {
        mysqli_query($koneksi, "insert into ipa_sulit set
...
<form action="" method="post">
    <table border="1">
        ...
        include "conn.php";
        $no = 1;
        $data = mysqli_query($koneksi, "select * from ipa_sulit ");
...
<?php
if(isset($_GET['kode'])){
    mysqli_query($koneksi, "delete from ipa_sulit where id_soal='$_GET[kode]'");
