  ...
  var timer = setInterval(function () {
    ...
    if (waktu < 0) {
      ...
      setTimeout(function () {
        ...
        window.location.href = "i-mtk-sulit.php";
...
$sql = "SELECT * FROM mtk_sulit ORDER BY RAND() LIMIT 15";
...
<div class='tayo'>
    <div>
    <h1>Kamu akan menjawab soal matematika tingkat sulit</h1>
