...
include "conn.php";
  if (isset($_POST['simpan'])) {
        mysqli_query($koneksi, "insert into ipa_normal set
...
<form action="" method="post">
    <table border="1">
        ...
        include "conn.php";
        $no = 1;
        $data = mysqli_query($koneksi, "select * from ipa_normal ");
...
<?php
if(isset($_GET['kode'])){
    mysqli_query($koneksi, "delete from ipa_normal where id_soal='$_GET[kode]'");
