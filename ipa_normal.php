  ...
  var timer = setInterval(function () {
    ...
    if (waktu < 0) {
      ...
      setTimeout(function () {
        ...
        window.location.href = "i-ipa-normal.php";
...
$sql = "SELECT * FROM ipa_normal ORDER BY RAND() LIMIT 15";
...
<div class='tayo'>
    <div>
    <h1>Kamu akan menjawab soal Ilmu Pengetahuan Alam tingkat Normal</h1>
